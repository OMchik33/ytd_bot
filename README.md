# ОБНОВЛЕНИЯ:
- **10.05.2025** - добавил bot2.sh скрипт с возможностями обновления компонентов бота и возможность установить скрипт бота на сервер "с нуля" с вариантами на уже рабочий nginx сервер с добавленными доменами, и вариант когда домены не используются. Настройка конфига nginx - слабое звено скрипта, может не справится если конфиг сложный, нужно вручную проверять. Функция автоустановки не нестировалась.
