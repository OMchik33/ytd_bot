![Last Update](https://img.shields.io/github/last-commit/OMchik33/ytd_bot?style=for-the-badge&color=blue&logo=github)

# ОБНОВЛЕНИЯ:
- **01.04.2026** - Поддержка проекта остановлена (бот на текущую дату полностью работоспособен. в дальнейшем требует лишь обновления yt-dlp компонентов и в редких случаев правки синтаксиса загрузки при изменениях на видеохостингах). | В связи с блокировкой Телеграм данную концепцию перенес на веб-сервис, который буду разрабатывать дальше.
- **30.03.2026** - фикс скачивания некоторых видео без звука
...
| `pip install aiogram yt-dlp yt-dlp-ejs python-dotenv` | Устанавливаем необходимое ПО |
...
6. **Устанавливаем ffmpeg и другие компоненты**
